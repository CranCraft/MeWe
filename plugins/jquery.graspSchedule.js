...
(function ($) {
    $.fn.graspSchedule = function (paramData) {
        ...
        var getScheduleHight = function (scheduleId) {
            ...
            var id2 = scheduleId + "forTakeHeight";
            if(paramData.options.insideTime){
        ...
        var graspSchedule = {
            ...
            drawTime: function (time) {
                ...
                jqueryThis.append("<div<div class='col-sm-1 " + paramData.options.classnames.time + "' id='" + id2 + "'>" + comDateFormat(time) + "</div>");
                $("#" + id2).css(css);
